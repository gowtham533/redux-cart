    ...
    <Navbar expand="lg" className="bg-success position-fixed w-100 z-1">
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Link to={'/wishlist'}className='text-decoration-none text-light fw-bold '><FontAwesomeIcon icon={faHeart} className='text-danger me-1'/>WISHLIST<Badge pill bg='dark' className='ms-1 me-3'>9</Badge></Link>
